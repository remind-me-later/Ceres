...
macro_rules! gbmicrotest_ignore {
    ($name:ident, $rom:literal) => {
        #[test]
        #[ignore]
        #[allow(non_snake_case)]
...
gbmicrotest_ignore!(test_n000_oam_lock, "000-oam_lock.gb");
gbmicrotest_ignore!(test_n000_write_to_x8000, "000-write_to_x8000.gb");
gbmicrotest_ignore!(test_n001_vram_unlocked, "001-vram_unlocked.gb");
gbmicrotest_ignore!(test_n002_vram_locked, "002-vram_locked.gb");
gbmicrotest_ignore!(test_n004_tima_boot_phase, "004-tima_boot_phase.gb");
gbmicrotest_ignore!(test_n004_tima_cycle_timer, "004-tima_cycle_timer.gb");
gbmicrotest_ignore!(test_n007_lcd_on_stat, "007-lcd_on_stat.gb");
gbmicrotest_ignore!(test_n400_dma, "400-dma.gb");
gbmicrotest_ignore!(test_n500_scx_timing, "500-scx-timing.gb");
gbmicrotest_ignore!(test_n800_ppu_latch_scx, "800-ppu-latch-scx.gb");
gbmicrotest_ignore!(test_n801_ppu_latch_scy, "801-ppu-latch-scy.gb");
gbmicrotest_ignore!(
    test_n802_ppu_latch_tileselect,
    "802-ppu-latch-tileselect.gb"
);
gbmicrotest_ignore!(test_n803_ppu_latch_bgdisplay, "803-ppu-latch-bgdisplay.gb");
gbmicrotest_ignore!(test_audio_testbench, "audio_testbench.gb");
gbmicrotest_ignore!(test_cpu_bus_1, "cpu_bus_1.gb");
...
gbmicrotest_ignore!(test_dma_basic, "dma_basic.gb");
gbmicrotest!(test_dma_timing_a, "dma_timing_a.gb");
gbmicrotest_ignore!(test_flood_vram, "flood_vram.gb");
gbmicrotest_ignore!(test_halt_bug, "halt_bug.gb");
gbmicrotest_ignore!(test_halt_op_dupe_delay, "halt_op_dupe_delay.gb");
...
gbmicrotest_ignore!(test_hblank_int_if_a, "hblank_int_if_a.gb");
gbmicrotest!(test_hblank_int_if_b, "hblank_int_if_b.gb");
gbmicrotest_ignore!(test_hblank_int_l0, "hblank_int_l0.gb");
...
gbmicrotest_ignore!(test_hblank_int_scx0_if_b, "hblank_int_scx0_if_b.gb");
gbmicrotest_ignore!(test_hblank_int_scx0_if_c, "hblank_int_scx0_if_c.gb");
gbmicrotest_ignore!(test_hblank_int_scx0_if_d, "hblank_int_scx0_if_d.gb");
gbmicrotest!(test_hblank_int_scx1, "hblank_int_scx1.gb");
gbmicrotest!(test_hblank_int_scx1_if_a, "hblank_int_scx1_if_a.gb");
gbmicrotest_ignore!(test_hblank_int_scx1_if_b, "hblank_int_scx1_if_b.gb");
gbmicrotest_ignore!(test_hblank_int_scx1_if_c, "hblank_int_scx1_if_c.gb");
gbmicrotest_ignore!(test_hblank_int_scx1_if_d, "hblank_int_scx1_if_d.gb");
gbmicrotest_ignore!(test_hblank_int_scx1_nops_a, "hblank_int_scx1_nops_a.gb");
gbmicrotest_ignore!(test_hblank_int_scx1_nops_b, "hblank_int_scx1_nops_b.gb");
gbmicrotest!(test_hblank_int_scx2, "hblank_int_scx2.gb");
gbmicrotest!(test_hblank_int_scx2_if_a, "hblank_int_scx2_if_a.gb");
gbmicrotest_ignore!(test_hblank_int_scx2_if_b, "hblank_int_scx2_if_b.gb");
gbmicrotest_ignore!(test_hblank_int_scx2_if_c, "hblank_int_scx2_if_c.gb");
gbmicrotest_ignore!(test_hblank_int_scx2_if_d, "hblank_int_scx2_if_d.gb");
gbmicrotest_ignore!(test_hblank_int_scx2_nops_a, "hblank_int_scx2_nops_a.gb");
gbmicrotest_ignore!(test_hblank_int_scx2_nops_b, "hblank_int_scx2_nops_b.gb");
gbmicrotest!(test_hblank_int_scx3, "hblank_int_scx3.gb");
gbmicrotest!(test_hblank_int_scx3_if_a, "hblank_int_scx3_if_a.gb");
gbmicrotest_ignore!(test_hblank_int_scx3_if_b, "hblank_int_scx3_if_b.gb");
gbmicrotest_ignore!(test_hblank_int_scx3_if_c, "hblank_int_scx3_if_c.gb");
gbmicrotest_ignore!(test_hblank_int_scx3_if_d, "hblank_int_scx3_if_d.gb");
gbmicrotest_ignore!(test_hblank_int_scx3_nops_a, "hblank_int_scx3_nops_a.gb");
gbmicrotest_ignore!(test_hblank_int_scx3_nops_b, "hblank_int_scx3_nops_b.gb");
gbmicrotest!(test_hblank_int_scx4, "hblank_int_scx4.gb");
gbmicrotest!(test_hblank_int_scx4_if_a, "hblank_int_scx4_if_a.gb");
gbmicrotest_ignore!(test_hblank_int_scx4_if_b, "hblank_int_scx4_if_b.gb");
gbmicrotest_ignore!(test_hblank_int_scx4_if_c, "hblank_int_scx4_if_c.gb");
gbmicrotest_ignore!(test_hblank_int_scx4_if_d, "hblank_int_scx4_if_d.gb");
gbmicrotest_ignore!(test_hblank_int_scx4_nops_a, "hblank_int_scx4_nops_a.gb");
gbmicrotest_ignore!(test_hblank_int_scx4_nops_b, "hblank_int_scx4_nops_b.gb");
gbmicrotest!(test_hblank_int_scx5, "hblank_int_scx5.gb");
gbmicrotest!(test_hblank_int_scx5_if_a, "hblank_int_scx5_if_a.gb");
gbmicrotest_ignore!(test_hblank_int_scx5_if_b, "hblank_int_scx5_if_b.gb");
gbmicrotest_ignore!(test_hblank_int_scx5_if_c, "hblank_int_scx5_if_c.gb");
gbmicrotest_ignore!(test_hblank_int_scx5_if_d, "hblank_int_scx5_if_d.gb");
gbmicrotest_ignore!(test_hblank_int_scx5_nops_a, "hblank_int_scx5_nops_a.gb");
gbmicrotest_ignore!(test_hblank_int_scx5_nops_b, "hblank_int_scx5_nops_b.gb");
gbmicrotest!(test_hblank_int_scx6, "hblank_int_scx6.gb");
gbmicrotest!(test_hblank_int_scx6_if_a, "hblank_int_scx6_if_a.gb");
gbmicrotest_ignore!(test_hblank_int_scx6_if_b, "hblank_int_scx6_if_b.gb");
gbmicrotest_ignore!(test_hblank_int_scx6_if_c, "hblank_int_scx6_if_c.gb");
gbmicrotest_ignore!(test_hblank_int_scx6_if_d, "hblank_int_scx6_if_d.gb");
gbmicrotest_ignore!(test_hblank_int_scx6_nops_a, "hblank_int_scx6_nops_a.gb");
gbmicrotest_ignore!(test_hblank_int_scx6_nops_b, "hblank_int_scx6_nops_b.gb");
gbmicrotest_ignore!(test_hblank_int_scx7, "hblank_int_scx7.gb");
gbmicrotest!(test_hblank_int_scx7_if_a, "hblank_int_scx7_if_a.gb");
gbmicrotest_ignore!(test_hblank_int_scx7_if_b, "hblank_int_scx7_if_b.gb");
gbmicrotest_ignore!(test_hblank_int_scx7_if_c, "hblank_int_scx7_if_c.gb");
gbmicrotest_ignore!(test_hblank_int_scx7_if_d, "hblank_int_scx7_if_d.gb");
gbmicrotest_ignore!(test_hblank_int_scx7_nops_a, "hblank_int_scx7_nops_a.gb");
gbmicrotest_ignore!(test_hblank_int_scx7_nops_b, "hblank_int_scx7_nops_b.gb");
gbmicrotest!(test_hblank_scx2_if_a, "hblank_scx2_if_a.gb");
gbmicrotest_ignore!(test_hblank_scx3_if_a, "hblank_scx3_if_a.gb");
gbmicrotest_ignore!(test_hblank_scx3_if_b, "hblank_scx3_if_b.gb");
gbmicrotest_ignore!(test_hblank_scx3_if_c, "hblank_scx3_if_c.gb");
gbmicrotest!(test_hblank_scx3_if_d, "hblank_scx3_if_d.gb");
gbmicrotest_ignore!(test_hblank_scx3_int_a, "hblank_scx3_int_a.gb");
...
gbmicrotest_ignore!(test_int_hblank_halt_scx0, "int_hblank_halt_scx0.gb");
gbmicrotest_ignore!(test_int_hblank_halt_scx1, "int_hblank_halt_scx1.gb");
gbmicrotest_ignore!(test_int_hblank_halt_scx2, "int_hblank_halt_scx2.gb");
gbmicrotest_ignore!(test_int_hblank_halt_scx3, "int_hblank_halt_scx3.gb");
gbmicrotest_ignore!(test_int_hblank_halt_scx4, "int_hblank_halt_scx4.gb");
gbmicrotest_ignore!(test_int_hblank_halt_scx5, "int_hblank_halt_scx5.gb");
gbmicrotest_ignore!(test_int_hblank_halt_scx6, "int_hblank_halt_scx6.gb");
gbmicrotest_ignore!(test_int_hblank_halt_scx7, "int_hblank_halt_scx7.gb");
gbmicrotest_ignore!(test_int_hblank_incs_scx0, "int_hblank_incs_scx0.gb");
gbmicrotest_ignore!(test_int_hblank_incs_scx1, "int_hblank_incs_scx1.gb");
gbmicrotest_ignore!(test_int_hblank_incs_scx2, "int_hblank_incs_scx2.gb");
gbmicrotest_ignore!(test_int_hblank_incs_scx3, "int_hblank_incs_scx3.gb");
gbmicrotest_ignore!(test_int_hblank_incs_scx4, "int_hblank_incs_scx4.gb");
gbmicrotest_ignore!(test_int_hblank_incs_scx5, "int_hblank_incs_scx5.gb");
gbmicrotest_ignore!(test_int_hblank_incs_scx6, "int_hblank_incs_scx6.gb");
gbmicrotest_ignore!(test_int_hblank_incs_scx7, "int_hblank_incs_scx7.gb");
gbmicrotest_ignore!(test_int_hblank_nops_scx0, "int_hblank_nops_scx0.gb");
gbmicrotest_ignore!(test_int_hblank_nops_scx1, "int_hblank_nops_scx1.gb");
gbmicrotest_ignore!(test_int_hblank_nops_scx2, "int_hblank_nops_scx2.gb");
gbmicrotest_ignore!(test_int_hblank_nops_scx3, "int_hblank_nops_scx3.gb");
gbmicrotest_ignore!(test_int_hblank_nops_scx4, "int_hblank_nops_scx4.gb");
gbmicrotest_ignore!(test_int_hblank_nops_scx5, "int_hblank_nops_scx5.gb");
gbmicrotest_ignore!(test_int_hblank_nops_scx6, "int_hblank_nops_scx6.gb");
gbmicrotest_ignore!(test_int_hblank_nops_scx7, "int_hblank_nops_scx7.gb");
gbmicrotest_ignore!(test_int_lyc_halt, "int_lyc_halt.gb");
gbmicrotest!(test_int_lyc_incs, "int_lyc_incs.gb");
gbmicrotest_ignore!(test_int_lyc_nops, "int_lyc_nops.gb");
gbmicrotest_ignore!(test_int_oam_halt, "int_oam_halt.gb");
gbmicrotest!(test_int_oam_incs, "int_oam_incs.gb");
gbmicrotest_ignore!(test_int_oam_nops, "int_oam_nops.gb");
...
gbmicrotest_ignore!(test_int_timer_incs, "int_timer_incs.gb");
gbmicrotest_ignore!(test_int_timer_nops_div_a, "int_timer_nops_div_a.gb");
gbmicrotest!(test_int_timer_nops_div_b, "int_timer_nops_div_b.gb");
gbmicrotest_ignore!(test_int_timer_nops, "int_timer_nops.gb");
gbmicrotest_ignore!(test_int_vblank1_halt, "int_vblank1_halt.gb");
gbmicrotest_ignore!(test_int_vblank1_incs, "int_vblank1_incs.gb");
gbmicrotest_ignore!(test_int_vblank1_nops, "int_vblank1_nops.gb");
gbmicrotest_ignore!(test_int_vblank2_halt, "int_vblank2_halt.gb");
gbmicrotest_ignore!(test_int_vblank2_incs, "int_vblank2_incs.gb");
gbmicrotest_ignore!(test_int_vblank2_nops, "int_vblank2_nops.gb");
gbmicrotest!(test_is_if_set_during_ime0, "is_if_set_during_ime0.gb");
gbmicrotest!(
...
gbmicrotest_ignore!(test_lcdon_to_if_oam_a, "lcdon_to_if_oam_a.gb");
...
gbmicrotest_ignore!(test_lcdon_to_oam_int_l1, "lcdon_to_oam_int_l1.gb");
gbmicrotest_ignore!(test_lcdon_to_oam_int_l2, "lcdon_to_oam_int_l2.gb");
...
gbmicrotest_ignore!(test_lcdon_to_stat0_c, "lcdon_to_stat0_c.gb");
gbmicrotest!(test_lcdon_to_stat0_d, "lcdon_to_stat0_d.gb");
gbmicrotest_ignore!(test_lcdon_to_stat1_a, "lcdon_to_stat1_a.gb");
gbmicrotest!(test_lcdon_to_stat1_b, "lcdon_to_stat1_b.gb");
gbmicrotest_ignore!(test_lcdon_to_stat1_c, "lcdon_to_stat1_c.gb");
gbmicrotest_ignore!(test_lcdon_to_stat1_d, "lcdon_to_stat1_d.gb");
gbmicrotest!(test_lcdon_to_stat1_e, "lcdon_to_stat1_e.gb");
gbmicrotest_ignore!(test_lcdon_to_stat2_a, "lcdon_to_stat2_a.gb");
gbmicrotest!(test_lcdon_to_stat2_b, "lcdon_to_stat2_b.gb");
gbmicrotest_ignore!(test_lcdon_to_stat2_c, "lcdon_to_stat2_c.gb");
...
gbmicrotest_ignore!(test_lcdon_to_stat3_c, "lcdon_to_stat3_c.gb");
gbmicrotest!(test_lcdon_to_stat3_d, "lcdon_to_stat3_d.gb");
gbmicrotest_ignore!(test_lcdon_write_timing, "lcdon_write_timing.gb");
...
gbmicrotest_ignore!(test_line_153_lyc_a, "line_153_lyc_a.gb");
gbmicrotest!(test_line_153_lyc_b, "line_153_lyc_b.gb");
gbmicrotest_ignore!(test_line_153_lyc_c, "line_153_lyc_c.gb");
gbmicrotest_ignore!(test_line_153_ly_c, "line_153_ly_c.gb");
gbmicrotest_ignore!(test_line_153_lyc_int_a, "line_153_lyc_int_a.gb");
gbmicrotest!(test_line_153_lyc_int_b, "line_153_lyc_int_b.gb");
gbmicrotest_ignore!(test_line_153_ly_d, "line_153_ly_d.gb");
...
gbmicrotest_ignore!(test_lyc1_int_if_edge_a, "lyc1_int_if_edge_a.gb");
gbmicrotest!(test_lyc1_int_if_edge_b, "lyc1_int_if_edge_b.gb");
gbmicrotest_ignore!(test_lyc1_int_if_edge_c, "lyc1_int_if_edge_c.gb");
...
gbmicrotest_ignore!(test_ly_while_lcd_off, "ly_while_lcd_off.gb");
gbmicrotest!(test_mbc1_ram_banks, "mbc1_ram_banks.gb");
gbmicrotest_ignore!(test_mbc1_rom_banks, "mbc1_rom_banks.gb");
gbmicrotest_ignore!(test_minimal, "minimal.gb");
gbmicrotest_ignore!(
    test_mode2_stat_int_to_oam_unlock,
    "mode2_stat_int_to_oam_unlock.gb"
);
gbmicrotest_ignore!(test_oam_int_halt_a, "oam_int_halt_a.gb");
gbmicrotest_ignore!(test_oam_int_halt_b, "oam_int_halt_b.gb");
gbmicrotest_ignore!(test_oam_int_if_edge_a, "oam_int_if_edge_a.gb");
gbmicrotest!(test_oam_int_if_edge_b, "oam_int_if_edge_b.gb");
gbmicrotest_ignore!(test_oam_int_if_edge_c, "oam_int_if_edge_c.gb");
gbmicrotest!(test_oam_int_if_edge_d, "oam_int_if_edge_d.gb");
gbmicrotest!(test_oam_int_if_level_c, "oam_int_if_level_c.gb");
gbmicrotest_ignore!(test_oam_int_if_level_d, "oam_int_if_level_d.gb");
gbmicrotest_ignore!(test_oam_int_inc_sled, "oam_int_inc_sled.gb");
gbmicrotest_ignore!(test_oam_int_nops_a, "oam_int_nops_a.gb");
gbmicrotest_ignore!(test_oam_int_nops_b, "oam_int_nops_b.gb");
...
gbmicrotest_ignore!(test_oam_read_l1_c, "oam_read_l1_c.gb");
gbmicrotest!(test_oam_read_l1_d, "oam_read_l1_d.gb");
gbmicrotest_ignore!(test_oam_read_l1_e, "oam_read_l1_e.gb");
gbmicrotest!(test_oam_read_l1_f, "oam_read_l1_f.gb");
gbmicrotest_ignore!(test_oam_sprite_trashing, "oam_sprite_trashing.gb");
...
gbmicrotest_ignore!(test_oam_write_l0_e, "oam_write_l0_e.gb");
gbmicrotest!(test_oam_write_l1_a, "oam_write_l1_a.gb");
gbmicrotest!(test_oam_write_l1_b, "oam_write_l1_b.gb");
gbmicrotest_ignore!(test_oam_write_l1_c, "oam_write_l1_c.gb");
gbmicrotest!(test_oam_write_l1_d, "oam_write_l1_d.gb");
gbmicrotest_ignore!(test_oam_write_l1_e, "oam_write_l1_e.gb");
gbmicrotest!(test_oam_write_l1_f, "oam_write_l1_f.gb");
gbmicrotest!(test_poweron_bgp_000, "poweron_bgp_000.gb");
gbmicrotest_ignore!(test_poweron_div_000, "poweron_div_000.gb");
gbmicrotest_ignore!(test_poweron_div_004, "poweron_div_004.gb");
gbmicrotest_ignore!(test_poweron_div_005, "poweron_div_005.gb");
gbmicrotest_ignore!(test_poweron_dma_000, "poweron_dma_000.gb");
gbmicrotest_ignore!(test_poweron, "poweron.gb");
gbmicrotest!(test_poweron_if_000, "poweron_if_000.gb");
gbmicrotest_ignore!(test_poweron_joy_000, "poweron_joy_000.gb");
gbmicrotest!(test_poweron_lcdc_000, "poweron_lcdc_000.gb");
gbmicrotest_ignore!(test_poweron_ly_000, "poweron_ly_000.gb");
gbmicrotest!(test_poweron_ly_119, "poweron_ly_119.gb");
gbmicrotest_ignore!(test_poweron_ly_120, "poweron_ly_120.gb");
gbmicrotest!(test_poweron_ly_233, "poweron_ly_233.gb");
gbmicrotest_ignore!(test_poweron_ly_234, "poweron_ly_234.gb");
...
gbmicrotest_ignore!(test_poweron_oam_006, "poweron_oam_006.gb");
gbmicrotest_ignore!(test_poweron_oam_069, "poweron_oam_069.gb");
gbmicrotest!(test_poweron_oam_070, "poweron_oam_070.gb");
gbmicrotest_ignore!(test_poweron_oam_119, "poweron_oam_119.gb");
gbmicrotest!(test_poweron_oam_120, "poweron_oam_120.gb");
gbmicrotest!(test_poweron_oam_121, "poweron_oam_121.gb");
gbmicrotest_ignore!(test_poweron_oam_183, "poweron_oam_183.gb");
gbmicrotest!(test_poweron_oam_184, "poweron_oam_184.gb");
gbmicrotest_ignore!(test_poweron_oam_233, "poweron_oam_233.gb");
gbmicrotest!(test_poweron_oam_234, "poweron_oam_234.gb");
gbmicrotest!(test_poweron_oam_235, "poweron_oam_235.gb");
gbmicrotest_ignore!(test_poweron_obp0_000, "poweron_obp0_000.gb");
gbmicrotest_ignore!(test_poweron_obp1_000, "poweron_obp1_000.gb");
...
gbmicrotest_ignore!(test_poweron_stat_000, "poweron_stat_000.gb");
gbmicrotest_ignore!(test_poweron_stat_005, "poweron_stat_005.gb");
gbmicrotest_ignore!(test_poweron_stat_006, "poweron_stat_006.gb");
gbmicrotest_ignore!(test_poweron_stat_007, "poweron_stat_007.gb");
gbmicrotest_ignore!(test_poweron_stat_026, "poweron_stat_026.gb");
gbmicrotest_ignore!(test_poweron_stat_027, "poweron_stat_027.gb");
gbmicrotest_ignore!(test_poweron_stat_069, "poweron_stat_069.gb");
gbmicrotest_ignore!(test_poweron_stat_070, "poweron_stat_070.gb");
gbmicrotest_ignore!(test_poweron_stat_119, "poweron_stat_119.gb");
gbmicrotest_ignore!(test_poweron_stat_120, "poweron_stat_120.gb");
gbmicrotest_ignore!(test_poweron_stat_121, "poweron_stat_121.gb");
gbmicrotest_ignore!(test_poweron_stat_140, "poweron_stat_140.gb");
gbmicrotest_ignore!(test_poweron_stat_141, "poweron_stat_141.gb");
gbmicrotest_ignore!(test_poweron_stat_183, "poweron_stat_183.gb");
gbmicrotest_ignore!(test_poweron_stat_184, "poweron_stat_184.gb");
gbmicrotest_ignore!(test_poweron_stat_234, "poweron_stat_234.gb");
gbmicrotest_ignore!(test_poweron_stat_235, "poweron_stat_235.gb");
...
gbmicrotest_ignore!(test_poweron_vram_026, "poweron_vram_026.gb");
gbmicrotest_ignore!(test_poweron_vram_069, "poweron_vram_069.gb");
gbmicrotest!(test_poweron_vram_070, "poweron_vram_070.gb");
gbmicrotest!(test_poweron_vram_139, "poweron_vram_139.gb");
gbmicrotest_ignore!(test_poweron_vram_140, "poweron_vram_140.gb");
gbmicrotest_ignore!(test_poweron_vram_183, "poweron_vram_183.gb");
...
gbmicrotest_ignore!(test_ppu_scx_vs_bgp, "ppu_scx_vs_bgp.gb");
gbmicrotest_ignore!(test_ppu_sprite0_scx0_a, "ppu_sprite0_scx0_a.gb");
gbmicrotest!(test_ppu_sprite0_scx0_b, "ppu_sprite0_scx0_b.gb");
gbmicrotest_ignore!(test_ppu_sprite0_scx1_a, "ppu_sprite0_scx1_a.gb");
gbmicrotest!(test_ppu_sprite0_scx1_b, "ppu_sprite0_scx1_b.gb");
gbmicrotest_ignore!(test_ppu_sprite0_scx2_a, "ppu_sprite0_scx2_a.gb");
gbmicrotest!(test_ppu_sprite0_scx2_b, "ppu_sprite0_scx2_b.gb");
gbmicrotest_ignore!(test_ppu_sprite0_scx3_a, "ppu_sprite0_scx3_a.gb");
gbmicrotest!(test_ppu_sprite0_scx3_b, "ppu_sprite0_scx3_b.gb");
gbmicrotest_ignore!(test_ppu_sprite0_scx4_a, "ppu_sprite0_scx4_a.gb");
gbmicrotest!(test_ppu_sprite0_scx4_b, "ppu_sprite0_scx4_b.gb");
gbmicrotest_ignore!(test_ppu_sprite0_scx5_a, "ppu_sprite0_scx5_a.gb");
gbmicrotest!(test_ppu_sprite0_scx5_b, "ppu_sprite0_scx5_b.gb");
gbmicrotest_ignore!(test_ppu_sprite0_scx6_a, "ppu_sprite0_scx6_a.gb");
gbmicrotest!(test_ppu_sprite0_scx6_b, "ppu_sprite0_scx6_b.gb");
gbmicrotest_ignore!(test_ppu_sprite0_scx7_a, "ppu_sprite0_scx7_a.gb");
gbmicrotest!(test_ppu_sprite0_scx7_b, "ppu_sprite0_scx7_b.gb");
gbmicrotest_ignore!(test_ppu_sprite_testbench, "ppu_sprite_testbench.gb");
gbmicrotest_ignore!(test_ppu_spritex_vs_scx, "ppu_spritex_vs_scx.gb");
gbmicrotest_ignore!(test_ppu_win_vs_wx, "ppu_win_vs_wx.gb");
gbmicrotest_ignore!(test_ppu_wx_early, "ppu_wx_early.gb");
gbmicrotest_ignore!(test_sprite_0_a, "sprite_0_a.gb");
gbmicrotest!(test_sprite_0_b, "sprite_0_b.gb");
gbmicrotest_ignore!(test_sprite_1_a, "sprite_1_a.gb");
gbmicrotest!(test_sprite_1_b, "sprite_1_b.gb");
gbmicrotest_ignore!(test_sprite4_0_a, "sprite4_0_a.gb");
gbmicrotest!(test_sprite4_0_b, "sprite4_0_b.gb");
gbmicrotest_ignore!(test_sprite4_1_a, "sprite4_1_a.gb");
gbmicrotest!(test_sprite4_1_b, "sprite4_1_b.gb");
gbmicrotest_ignore!(test_sprite4_2_a, "sprite4_2_a.gb");
gbmicrotest!(test_sprite4_2_b, "sprite4_2_b.gb");
gbmicrotest_ignore!(test_sprite4_3_a, "sprite4_3_a.gb");
gbmicrotest!(test_sprite4_3_b, "sprite4_3_b.gb");
gbmicrotest_ignore!(test_sprite4_4_a, "sprite4_4_a.gb");
...
gbmicrotest_ignore!(test_sprite4_7_b, "sprite4_7_b.gb");
gbmicrotest_ignore!(test_stat_write_glitch_l0_a, "stat_write_glitch_l0_a.gb");
gbmicrotest_ignore!(test_stat_write_glitch_l0_b, "stat_write_glitch_l0_b.gb");
...
gbmicrotest_ignore!(test_stat_write_glitch_l143_b, "stat_write_glitch_l143_b.gb");
gbmicrotest_ignore!(test_stat_write_glitch_l143_c, "stat_write_glitch_l143_c.gb");
gbmicrotest_ignore!(test_stat_write_glitch_l143_d, "stat_write_glitch_l143_d.gb");
gbmicrotest_ignore!(test_stat_write_glitch_l154_a, "stat_write_glitch_l154_a.gb");
gbmicrotest_ignore!(test_stat_write_glitch_l154_b, "stat_write_glitch_l154_b.gb");
gbmicrotest!(test_stat_write_glitch_l154_c, "stat_write_glitch_l154_c.gb");
gbmicrotest_ignore!(test_stat_write_glitch_l154_d, "stat_write_glitch_l154_d.gb");
gbmicrotest!(test_stat_write_glitch_l1_a, "stat_write_glitch_l1_a.gb");
gbmicrotest_ignore!(test_stat_write_glitch_l1_b, "stat_write_glitch_l1_b.gb");
gbmicrotest_ignore!(test_stat_write_glitch_l1_c, "stat_write_glitch_l1_c.gb");
gbmicrotest!(test_stat_write_glitch_l1_d, "stat_write_glitch_l1_d.gb");
gbmicrotest_ignore!(test_temp, "temp.gb");
...
gbmicrotest_ignore!(test_toggle_lcdc, "toggle_lcdc.gb");
gbmicrotest!(test_vblank2_int_halt_a, "vblank2_int_halt_a.gb");
gbmicrotest_ignore!(test_vblank2_int_halt_b, "vblank2_int_halt_b.gb");
gbmicrotest_ignore!(test_vblank2_int_if_a, "vblank2_int_if_a.gb");
gbmicrotest!(test_vblank2_int_if_b, "vblank2_int_if_b.gb");
gbmicrotest_ignore!(test_vblank2_int_if_c, "vblank2_int_if_c.gb");
gbmicrotest!(test_vblank2_int_if_d, "vblank2_int_if_d.gb");
gbmicrotest_ignore!(test_vblank2_int_inc_sled, "vblank2_int_inc_sled.gb");
gbmicrotest!(test_vblank2_int_nops_a, "vblank2_int_nops_a.gb");
gbmicrotest_ignore!(test_vblank2_int_nops_b, "vblank2_int_nops_b.gb");
gbmicrotest!(test_vblank_int_halt_a, "vblank_int_halt_a.gb");
gbmicrotest_ignore!(test_vblank_int_halt_b, "vblank_int_halt_b.gb");
gbmicrotest_ignore!(test_vblank_int_if_a, "vblank_int_if_a.gb");
gbmicrotest!(test_vblank_int_if_b, "vblank_int_if_b.gb");
gbmicrotest_ignore!(test_vblank_int_if_c, "vblank_int_if_c.gb");
gbmicrotest!(test_vblank_int_if_d, "vblank_int_if_d.gb");
gbmicrotest_ignore!(test_vblank_int_inc_sled, "vblank_int_inc_sled.gb");
gbmicrotest!(test_vblank_int_nops_a, "vblank_int_nops_a.gb");
gbmicrotest_ignore!(test_vblank_int_nops_b, "vblank_int_nops_b.gb");
...
gbmicrotest_ignore!(test_vram_read_l1_c, "vram_read_l1_c.gb");
...
gbmicrotest_ignore!(test_vram_write_l1_a, "vram_write_l1_a.gb");
