...
fn test_speed_change_tima() {
    ...
    assert_eq!(gb.read_mem(0xFF05), 128, "TIMA should increment 128 times during 32768 M-cycle speed switch");
    ...
    assert_eq!(gb.read_mem(0xFF04), 0, "DIV should be 0 immediately after speed switch");
}
